---
name: lspec
description: "Spec-Driven Development. Pipeline SEQUENCIAL: /lspec [request] → Discovery → Research → [Discuss?] → Specify → [Clarify?] → [Design?] → Tasks → Execute. Auto-avança. Salva estado após cada fase."
license: CC-BY-4.0
metadata:
