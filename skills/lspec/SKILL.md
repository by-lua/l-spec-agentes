---
name: lspec
description: "Spec-Driven Development. Pipeline SEQUENCIAL: /lspec [request] → Discovery → Research → Specify → Tasks → Execute. Auto-avança. Salva estado após cada fase."
license: CC-BY-4.0
metadata:
