...
Overview of how components interact. Use mermaid diagrams when helpful. Before creating any diagrams, check if `mermaid-studio` is installed (see PI Package Integrations in SKILL.md).
...
- **Keep it visual** — Diagrams save 1000 words (check mermaid-studio in PI Package Integrations)
